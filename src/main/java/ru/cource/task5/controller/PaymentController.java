...
import ru.cource.task5.exception.ErrorMessage;
import ru.cource.task5.model.Payment;
import ru.cource.task5.model.Product;
import ru.cource.task5.service.PaymentService;
...
public class PaymentController {
    ...
    public Product debitPayment(@RequestBody Payment payment){
    ...
    public Product creditPayment(@RequestBody Payment payment){
        var product = getProductbyId(payment.getProductId());
